...
| FIRE Dashboard | `/fire-goals/dashboard` | ✅ conformed | On `LeafPageHeader` (eyebrow + Edit-profile action in `#actions`) + FireHero + SectionCard tiles + chip DiscoveryFooter. |
