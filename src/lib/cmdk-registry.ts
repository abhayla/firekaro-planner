...
const NAV: Array<Pick<CmdItem, "id" | "label" | "icon" | "keywords"> & { path: string }> = [
  ...
  { id: "nav-health-score", label: "Health — Score", path: "/financial-health", icon: "mdi-heart-pulse" },
  { id: "nav-health-networth", label: "Health — Net Worth", path: "/financial-health/net-worth", icon: "mdi-chart-line-variant" },
  { id: "nav-health-cashflow", label: "Health — Cash Flow", path: "/financial-health/cash-flow", icon: "mdi-cash-flow" },
  { id: "nav-health-banking", label: "Health — Banking", path: "/financial-health/banking", icon: "mdi-bank" },
  { id: "nav-health-emergency", label: "Health — Emergency Fund", path: "/financial-health/emergency-fund", icon: "mdi-shield-alert" },
  { id: "nav-health-reports", label: "Health — Reports", path: "/financial-health/reports", icon: "mdi-file-chart" },
